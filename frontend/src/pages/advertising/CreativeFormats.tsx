    ...
    <div className="p-6 space-y-6" dir="rtl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">إنشاء إعلانات بتنسيقات متقدمة لتجربة مستخدم أفضل</p>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <Icon className={`w-8 h-8 ${isActive ? `text-${type.color}-600` : 'text-gray-400'}`} />
                {isActive && <CheckCircle className={`w-5 h-5 text-${type.color}-600`} />}
              </div>
              <h3 className={`font-bold mt-3 ${isActive ? `text-${type.color}-900` : 'text-gray-900'}`}>
                {type.nameAr}
              </h3>
              <p className="text-xs text-gray-500 mt-1">{type.name}</p>
              <p className={`text-sm mt-2 ${isActive ? `text-${type.color}-700` : 'text-gray-600'}`}>
                {type.description}
              </p>
            </button>
          );
      ...
      <div className="bg-white rounded-xl shadow-sm border">
        ...
        {activeType === 'collection' && (
          <div className="p-6 space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">النص الأساسي</label>
              <textarea
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-medium text-gray-700">معرفات المنتجات</label>
                <button
                  onClick={addProduct}
