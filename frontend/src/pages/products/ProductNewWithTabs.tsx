...
const ProductNewWithTabs: React.FC = () => {
  ...
  const tabs = [
    ...
    ...(uploadedImages.length > 0 
      ? [{ 
          ...
          badge: String(uploadedImages.length)
        }]
      : [{ 
          id: 'media', 
          label: 'الصور', 
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  أدخل معلومات المنتج الجديد باستخدام نظام التبويبات المنظم
                </p>
              </div>
            </div>
          </div>
...
export default ProductNewWithTabs;
