...
const ProductReviews: React.FC = () => {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const response = await axios.get(`${config.apiUrl}/reviews`, {
        params,
        headers: {
  ...
  const handleApprove = async (reviewId: string) => {
    try {
      const response = await axios.put(`${config.apiUrl}/reviews/${reviewId}/approve`, {}, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('accessToken')}`
        }
      });
  ...
  const handleReject = async (reviewId: string) => {
    try {
      const response = await axios.put(`${config.apiUrl}/reviews/${reviewId}/reject`, {}, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('accessToken')}`
        }
      });
  ...
  const handleDelete = async (reviewId: string) => {
    ...
    try {
      const response = await axios.delete(`${config.apiUrl}/reviews/${reviewId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('accessToken')}`
        }
      });
